...
function App() {
  ...
  return <div className="game-shell">
    ...
    <main><section className={`scene ${placing ? 'placement-mode' : ''}`}><div className="sign">✦ THE WANDERING ANVIL ✦</div><div className="room">
      <div className="shop-ground" aria-hidden="true"/><div className="front-path" aria-hidden="true"/><div className="floor-depth" aria-hidden="true"/><div className="wall-coping" aria-hidden="true"/>
