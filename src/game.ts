...
export const loadSave=():Save=>{try{
 ...
 return{...s,version:18,displays,customers,discoveredCustomers,discoveredRecipes,inventory:{...emptyInventory(),...s.inventory},mastery:{...emptyMastery(),...s.mastery},dailyProductSales:{...emptyInventory(),...(s.dailyProductSales||{})},missedRequests:s.missedRequests||0,displaySales:s.displaySales||0,wagesPaid:s.wagesPaid||0,deliveryPaid:s.deliveryPaid||0,reputationStart:s.reputationStart??s.reputation??0,speed:s.speed===2?2:1,autoPause:s.autoPause!==false}
